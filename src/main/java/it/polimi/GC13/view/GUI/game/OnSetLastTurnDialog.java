...
public class OnSetLastTurnDialog extends JDialog implements CardManager {
    ...
    /**
     * The {@code ResourceGetter} instance used to retrieve resource URLs.
     */
    private final ResourceGetter resourceGetter = new ResourceGetter();

    /**
     * Constructs an {@code OnSetLastTurnDialog}.
     *
     * @param frameManager   The {@link FrameManager} instance managing the GUI frame
