...
/**
 * The {@code ResourceCardGetter} class implements the {@link Getter} interface and provides
 * a method to retrieve a resource URL based on the resource name.
 * This class is typically used for loading resources related to resource cards
 * in the game GUI.
 */
